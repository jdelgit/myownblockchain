...
class keymanagerAsyncTest(unittest.IsolatedAsyncioTestCase):
    async def test_generate_keypair_from_seed(self):
        wallet_data_control = {
            "private": "97dfa9bfb4247533ae0b4f53bf6e26f133d98abe06d5c4850a1ea2f87c7a2e99",
            "public": "8d71dd37f43962973c8ee1c48a15ab8b8a03506f4a6343d4ec351abe3b27d99f",
            "nonce": 0,
        ...
        wallet_data = await km.generate_keypair_from_seed(
            wallet_data_control["wallet_seed"]
        )
        self.assertDictEqual(wallet_data, wallet_data_control)
