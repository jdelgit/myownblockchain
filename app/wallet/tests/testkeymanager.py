...
class keymanagerTest(unittest.TestCase):
    ...
    def test_generate_private_key(self):
        ...
        seed_hex_control = '97dfa9bfb4247533ae0b4f53bf6e26f133d98abe06d5c4850a1ea2f87c7a2e99'
        generated_key = km.generate_private_key(seed)
        self.assertEqual(generated_key,seed_hex_control)

    def test_generate_public_key(self):
        private_key_hex = '97dfa9bfb4247533ae0b4f53bf6e26f133d98abe06d5c4850a1ea2f87c7a2e99'
        nonce=0

        public_key_control = '8d71dd37f43962973c8ee1c48a15ab8b8a03506f4a6343d4ec351abe3b27d99f'
    ...
    def test_generate_keypair_from_privatekey(self):
        ...
        wallet_data = km.generate_keypair_from_privatekey(wallet_data_control["private"])
        self.assertDictEqual(wallet_data,wallet_data_control)
